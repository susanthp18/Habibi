#!/usr/bin/env node
/**
 * No route file over 500 lines, no component file over 800; the ones that
 * still are may only shrink.
 *
 ...
 * and a listed file may not grow. Test files are not measured.
 */
...
const LIMITS = { "src/routes": 500, "src/components": 800 };
