...
import { createWorkflowDraftApiV1WorkflowWorkflowIdCreateDraftPost, getWorkflowVersionsApiV1WorkflowWorkflowIdVersionsGet, listDocumentsApiV1KnowledgeBaseDocumentsGet, listRecordingsApiV1WorkflowRecordingsGet, listToolsApiV1ToolsGet } from '@/agentstudio/client';
import type { DocumentResponseSchema, RecordingResponseSchema, ToolResponse, WorkflowVersionResponse } from '@/agentstudio/client/types.gen';
import { useNodeSpecs } from "@/agentstudio/components/flow/renderer";
import { FlowEdge, FlowNode, NodeType } from "@/agentstudio/components/flow/types";
import { HireExpertNudge } from "@/agentstudio-host/shims/nothing";
import { Button } from '@/agentstudio/components/ui/button';
import { Sheet, SheetContent } from '@/agentstudio/components/ui/sheet';
import { Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from '@/agentstudio/components/ui/tooltip';
import { useOnboarding } from '@/agentstudio/context/OnboardingContext';
import { detailFromError } from '@/agentstudio/lib/apiError';
import { WorkflowConfigurations } from '@/agentstudio/types/workflow-configurations';
