...
const SERVICE_KEYS_DOCS_URL = (import.meta.env.BASE_URL + "studio/docs/configurations/api-keys#service-keys");
...
export const ApiKeyErrorDialog = ({
    ...
    const icon = isQuotaError ? <CreditCard className="h-5 w-5 text-text-brand" /> : <Key className="h-5 w-5 text-text-danger" />;
                            ...
                            <div className="text-sm space-y-1">
                                ...
                                {isBillingCreditsError && (
                                    <p className="text-muted-foreground">
                                        Purchase credits from Billing to continue using PayInt Voice Studio-managed models.
                                    </p>
                                )}
                                {isServiceKeyOrgMismatch && (
                                    <a
