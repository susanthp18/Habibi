...
import type { TextChatInactivityTimeoutConstraints, WidgetTexts } from "@/agentstudio/client/types.gen";
import { Button } from "@/agentstudio/components/ui/button";
import {
    Collapsible,
    CollapsibleContent,
    CollapsibleTrigger,
} from "@/agentstudio/components/ui/collapsible";
import {
    Dialog,
    DialogContent,
    DialogDescription,
...
import { Separator } from "@/agentstudio/components/ui/separator";
import { Switch } from "@/agentstudio/components/ui/switch";
import { WIDGET_CONTEXT_DOC_URL, WIDGET_MODE_DOCUMENTATION_URLS } from "@/agentstudio/constants/documentation";
import { HEADLESS_CHAT_EXAMPLE } from "@/agentstudio/constants/embedExamples";
import { detailFromError } from "@/agentstudio/lib/apiError";
import { copyTextToClipboard } from "@/agentstudio/lib/clipboard";
import type { WorkflowConfigurations } from "@/agentstudio/types/workflow-configurations";
                                ...
                                <div className="space-y-4">
                                    ...
                                    {embedMode === "headless" && widgetType === "chat" && (
                                        <div className="space-y-3">
                                            ...
                                            <div className="rounded-lg bg-background-information dark:bg-background-information-bold/20 p-4 border border-border-information dark:border-border-information">
                                                <h4 className="font-medium mb-2 text-text-information dark:text-text-information">Example - drive your own chat UI</h4>
                                                <pre className="text-xs overflow-x-auto">
                                                    <code className="text-text-information dark:text-text-information">{HEADLESS_CHAT_EXAMPLE}</code>
                                                </pre>
                                            </div>
                                        </div>
                                    )}
                                    ...
                                    {embedMode === "headless" && widgetType === "voice" && (
                                        <div className="space-y-3">
                                            ...
                                            <div className="rounded-lg bg-background-information dark:bg-background-information-bold/20 p-4 border border-border-information dark:border-border-information">
                                                <h4 className="font-medium mb-2 text-text-information dark:text-text-information">Example - track status in your own state</h4>
                                                <p className="text-xs text-text-information/80 dark:text-text-information/80 mb-2">
                                                ...
                                                <pre className="text-xs overflow-x-auto">
                                                    <code className="text-text-information dark:text-text-information">{`// Vanilla JS - keep your own state, render however you want
let callStatus = 'idle';
...
document.getElementById('talk-btn').addEventListener('click', () => {
  if (callStatus === 'connected' || callStatus === 'connecting') {
    ...
    window.DograhWidget.start();
                                                ...
                                                <p className="text-xs text-text-information/80 dark:text-text-information/80 mt-3 mb-2">React:</p>
                                                <pre className="text-xs overflow-x-auto">
                                                    <code className="text-text-information dark:text-text-information">{`function TalkButton() {
      ...
      {/* render anything you want from \`status\` */}
                                    ...
                                    {embedMode === "inline" && (
                                        <div className="space-y-3">
                                            ...
                                            {widgetType === "chat" ? (
                                                <div className="rounded-lg bg-background-information dark:bg-background-information-bold/20 p-4 border border-border-information dark:border-border-information">
                                                    <h4 className="font-medium mb-2 text-text-information dark:text-text-information">Example</h4>
                                                    <pre className="text-xs overflow-x-auto">
                                                        <code className="text-text-information dark:text-text-information">{`<h2>Chat with Our Agent</h2>
<div id="dograh-inline-container" style="min-height: 480px">
  <!-- Chat panel renders here; no extra JS needed -->
                                                ...
                                                <div className="rounded-lg bg-background-information dark:bg-background-information-bold/20 p-4 border border-border-information dark:border-border-information">
                                                    <h4 className="font-medium mb-2 text-text-information dark:text-text-information">Example React Component</h4>
                                                    <pre className="text-xs overflow-x-auto">
                                                        <code className="text-text-information dark:text-text-information">{`export function DograhAgent() {
