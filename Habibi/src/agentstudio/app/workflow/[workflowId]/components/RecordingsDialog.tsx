...
} from "@/agentstudio/client";
import type { RecordingResponseSchema, RecordingUploadResponseSchema } from "@/agentstudio/client/types.gen";
                            ...
                            {isRecording && (
                                <div className="flex items-center gap-3">
                                    <span className="relative flex h-3 w-3">
                                        <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-background-danger-bold opacity-75" />
                                        <span className="relative inline-flex rounded-full h-3 w-3 bg-background-danger-bold" />
                                    </span>
