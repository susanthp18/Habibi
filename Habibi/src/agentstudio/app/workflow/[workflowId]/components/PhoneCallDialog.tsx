...
export const PhoneCallDialog = ({
        ...
        return (
            <>
                <DialogHeader>
                    ...
                    <DialogDescription>
                        PayInt Voice Studio doesn&apos;t sell phone numbers or minutes. Choose how
                ...
                <div className="flex flex-col gap-3">
                    <div className="rounded-lg border p-4 space-y-3">
                        <div className="space-y-1">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="rounded-full bg-background-success-bold/10 px-2 py-0.5 text-[10px] font-medium uppercase tracking-wide text-text-success dark:text-text-success">
                                    Recommended
                                </span>
                            </div>
                    ...
                    <div className="rounded-lg border p-4 space-y-3">
                        <div className="space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Already have a SIP trunk or a PBX? Point it at PayInt Voice Studio and
    ...
    const renderPhoneCallForm = () => (
        <>
            ...
            {telephonyConfigs.length > 0 && (
                <div className="flex flex-col gap-1.5">
                    ...
                    {selectedConfigBlocked && (
                        <p className="text-xs text-text-warning dark:text-text-warning">
            ...
            {callError && <div className="text-text-danger text-sm mt-2">{callError}</div>}
            {callSuccessMsg && <div className="text-text-success text-sm mt-2">{callSuccessMsg}</div>}
        </>
    );
