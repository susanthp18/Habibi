import type { WorkflowRunTextSessionResponse } from "@/agentstudio/client/types.gen";
import type { ConversationNodeTransitionItem } from "@/agentstudio/components/workflow/conversation";
