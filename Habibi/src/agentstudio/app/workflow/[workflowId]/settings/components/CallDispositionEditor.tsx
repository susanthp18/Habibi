...
import type { CallDispositionOption } from "@/agentstudio/types/workflow-configurations";
            ...
            <div className="flex items-center justify-between gap-6">
                <div className="space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground">
                        {enabled
                            ? `${rows.length} outcome${rows.length === 1 ? "" : "s"} configured. PayInt Voice Studio will classify the completed conversation into one of them.`
                            : "Disabled. PayInt Voice Studio will keep the disposition recorded by the call-ending event."}
                    </p>
                </div>
