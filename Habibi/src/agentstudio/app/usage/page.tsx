...
import { useRouter, useSearchParams } from '@/agentstudio-host/shims/next-navigation';
import { useCallback, useEffect, useId, useMemo, useState } from 'react';
import TimezoneSelect, { type ITimezoneOption } from 'react-timezone-select';
import { toast } from 'sonner';

import { downloadUsageRunsReportApiV1OrganizationsUsageRunsReportGet, getDailyUsageBreakdownApiV1OrganizationsUsageDailyBreakdownGet, getPreferencesApiV1OrganizationsPreferencesGet, getUsageHistoryApiV1OrganizationsUsageRunsGet, getWorkflowsSummaryApiV1WorkflowSummaryGet, savePreferencesApiV1OrganizationsPreferencesPut } from '@/agentstudio/client/sdk.gen';
import type { DailyUsageBreakdownResponse, OrganizationPreferences, UsageHistoryResponse, WorkflowRunUsageResponse, WorkflowSummaryResponse } from '@/agentstudio/client/types.gen';
import { CallTypeCell } from '@/agentstudio/components/CallTypeCell';
import { DailyUsageTable } from '@/agentstudio/components/DailyUsageTable';
import { FilterBuilder } from '@/agentstudio/components/filters/FilterBuilder';
...
import {
    ...
    TableHeader,
    TableRow,
} from '@/agentstudio/components/ui/table';
import { useUserConfig } from '@/agentstudio/context/UserConfigContext';
import { useDispositionCodes } from '@/agentstudio/hooks/useDispositionCodes';
import { detailFromError } from '@/agentstudio/lib/apiError';
import { useAuth } from '@/agentstudio-host/auth';
import { formatDateTime, getLocalTimezone } from '@/agentstudio/lib/dateTime';
import { usageFilterAttributes, withDispositionCodeOptions } from '@/agentstudio/lib/filterAttributes';
import { decodeFiltersFromURL, encodeFiltersToURL } from '@/agentstudio/lib/filters';
import type { ActiveFilter, DateRangeValue, FilterAttribute, NumberFilterOption } from '@/agentstudio/types/filters';
                                    ...
                                    <div className="mt-4 p-3 bg-muted rounded-md">
                                        <p className="text-sm text-muted-foreground">
                                            Total for filtered period: <span className="font-semibold text-foreground">
                                                {usageHistory.total_dograh_tokens.toLocaleString()} PayInt Voice Studio Tokens
                                            </span>
                                            {' • '}
