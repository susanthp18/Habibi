...
import { useParams, useRouter } from "@/agentstudio-host/shims/next-navigation";
...
import { ConfigFormDialog } from "@/agentstudio/components/telephony/ConfigFormDialog";
import { PhoneNumberDialog } from "@/agentstudio/components/telephony/PhoneNumberDialog";
import { SetupChecklistCard } from "@/agentstudio/components/telephony/SetupChecklistCard";
import { SipConnectivityCard } from "@/agentstudio/components/telephony/SipConnectivityCard";
import { TrunkCard } from "@/agentstudio/components/telephony/TrunkCard";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
  ...
  AlertDialogHeader,
  AlertDialogTitle,
} from "@/agentstudio/components/ui/alert-dialog";
...
export default function TelephonyConfigurationDetailPage() {
  ...
  // ARI only: PayInt Voice Studio generates the Stasis application name, so the dialplan
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <p className="text-muted-foreground">
                    PayInt Voice Studio stopped reconnecting after repeated connection
                    failures
        ...
        <CardHeader className="flex flex-row items-start justify-between gap-4">
          <div className="space-y-1">
            ...
            <CardDescription>
              ...
              <a
                href={import.meta.env.BASE_URL + "studio/docs/integrations/telephony/inbound"}
                target="_blank"
                          ...
                          <span
                            className={
                              (config.trunks?.length ?? 0) > 1
                                ? "text-text-warning dark:text-text-warning"
                                : undefined
                            }
                          >
                            Unassigned
