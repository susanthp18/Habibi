...
import { useSearchParams } from "@/agentstudio-host/shims/next-navigation";
...
import { useTelephonyConfigWarnings } from "@/agentstudio/context/TelephonyConfigWarningsContext";
    ...
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-muted-foreground">
              ...
              <a
                href={import.meta.env.BASE_URL + "studio/docs/integrations/telephony/overview"}
                target="_blank"
        ...
        {telnyxMissingWebhookPublicKeyCount > 0 && (
          <div className="mb-6 rounded-md border border-border-warning bg-background-warning p-4 text-text-warning dark:border-border-warning dark:bg-background-warning-bold dark:text-text-warning">
                    ...
                    <div className="flex flex-col gap-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        {!item.inactive && item.is_ready_for_outbound === false && (
                          <Badge
                            variant="outline"
                            className="gap-1 border-border-warning text-text-warning dark:border-border-warning dark:text-text-warning"
                          >
                      ...
                      {!item.inactive && item.outbound_blocked_reason && (
                        <span className="text-sm text-text-warning dark:text-text-warning">
