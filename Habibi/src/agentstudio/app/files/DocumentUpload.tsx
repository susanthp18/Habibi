...
import type { DocumentUploadResponseSchema } from '@/agentstudio/client/types.gen';
import { Button } from '@/agentstudio/components/ui/button';
import { Label } from '@/agentstudio/components/ui/label';
import { Progress } from '@/agentstudio/components/ui/progress';
...
export default function DocumentUpload({ onUploadSuccess }: DocumentUploadProps) {
  ...
  const ossNotice = isOSS ? (
    <div className="flex gap-3 rounded-lg border border-border-warning bg-background-warning p-3 dark:border-border-warning/50 dark:bg-background-warning-bold/30">
      <Info className="h-4 w-4 flex-shrink-0 text-text-warning dark:text-text-warning mt-0.5" />
