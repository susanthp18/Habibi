...
import type { ApiKeyResponse, CreateApiKeyResponse, CreateServiceKeyResponse,ServiceKeyResponse } from '@/agentstudio/client/types.gen';
...
import { WHITELABEL } from '@/agentstudio-host/whitelabel';
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">Manage your API keys to access PayInt Voice Studio services programmatically</p>
                    </div>
                    ...
                    {/* PayInt Voice Studio Service Keys Section (the vendor's hosted models; hidden white-label) */}
                    {!WHITELABEL && <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>PayInt Voice Studio Service Keys</CardTitle>
                                    <CardDescription>
                                        Manage service keys for accessing PayInt Voice Studio AI services (LLM, TTS, STT)
                                    </CardDescription>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text">
                                            To generate additional service keys, <a href="#" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Sign up on app.dograh.com</a>
                                        </span>
                                    )}
                                </div>
                            </div>
                    ...
                    <div className="p-4 bg-background-warning-bold/10 border border-border-warning/20 rounded-lg">
                        <p className="text-sm text-text-warning dark:text-text-warning">
            ...
            <Dialog open={isCreateServiceDialogOpen} onOpenChange={setIsCreateServiceDialogOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Create a service key to access PayInt Voice Studio AI services (LLM, TTS, STT)
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                ...
                <DialogContent>
                    ...
                    {createdServiceKey && (
                        <div className="space-y-4">
                            ...
                            <div className="p-4 bg-background-information-bold/10 border border-border-information/20 rounded-lg">
                                <p className="text-sm text-text-information dark:text-text-information">
                                    This key provides access to PayInt Voice Studio AI services including LLM, Text-to-Speech, and Speech-to-Text.
