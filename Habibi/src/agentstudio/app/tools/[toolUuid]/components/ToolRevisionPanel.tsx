...
import { JsonEditor, validateJson } from "@/agentstudio/components/ui/json-editor";
...
import ToolReview from "@/agentstudio-host/ToolReview";
...
const STATE_STYLE: Record<ToolRevisionState, string> = {
    ...
    submitted: "bg-background-warning-bold/10 text-text-warning",
    approved: "bg-background-success-bold/10 text-text-success",
