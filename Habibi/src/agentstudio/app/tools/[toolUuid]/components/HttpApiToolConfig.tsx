...
import { StaticTextWarning, TextOrAudioInput } from "@/agentstudio/components/flow/TextOrAudioInput";
import {
    CredentialSelector,
...
import { BodyTemplateEditor } from "@/agentstudio/components/http/body-template-editor";
                ...
                <Tabs defaultValue="settings" className="w-full">
                    ...
                    <TabsContent value="settings" className="space-y-4 mt-4">
                        ...
                        <div className="grid gap-2">
                            ...
                            {urlHostnameParameters.length > 0 && (
                                <div className="rounded-lg border border-border-information/20 bg-background-information-bold/10 p-3 text-sm text-text-information flex gap-2 items-start mt-2">
                    ...
                    <TabsContent value="parameters" className="space-y-4 mt-4">
                        ...
                        <div className="grid gap-2 pt-4 border-t">
                            ...
                            <Label className="text-xs text-muted-foreground">
                                Add values that PayInt Voice Studio should inject at runtime. These are not exposed to the LLM and can use
