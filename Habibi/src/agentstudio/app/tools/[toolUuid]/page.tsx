...
import { Tooltip, TooltipContent, TooltipTrigger } from "@/agentstudio/components/ui/tooltip";
import { TOOL_DOCUMENTATION_URLS } from "@/agentstudio/constants/documentation";
        ...
        <div className="min-h-screen">
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-4xl mx-auto">
                    ...
                    {saveSuccess && (
                        <div className="mt-4 p-4 bg-background-success-bold/10 border border-border-success/20 rounded-lg text-text-success">
