...
import type { WorkflowRunDetail } from '@/agentstudio/client/types.gen';
import { Button } from '@/agentstudio/components/ui/button';
import { Calendar as CalendarPicker } from '@/agentstudio/components/ui/calendar';
import { Card } from '@/agentstudio/components/ui/card';
...
export default function ReportsPage() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      {error && !loading && (
        <Card className="p-6">
          <p className="text-center text-text-danger">{error}</p>
        </Card>
      )}
