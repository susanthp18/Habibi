...
import { useParams, useRouter, useSearchParams } from '@/agentstudio-host/shims/next-navigation';
...
import type { CampaignResponse } from '@/agentstudio/client/types.gen';
...
import { CampaignRuns } from '@/agentstudio/components/workflow-runs';
import { useOrganizationTimezone } from '@/agentstudio/hooks/useOrganizationTimezone';
import { useAuth } from '@/agentstudio-host/auth';
import { formatDate, formatDateTime } from '@/agentstudio/lib/dateTime';
...
export default function CampaignDetailPage() {
    ...
    const getLogIcon = (level: string) => {
        switch (level) {
            ...
            case 'warning':
                return <AlertTriangle className="h-4 w-4 text-text-warning" />;
            default:
                return <Info className="h-4 w-4 text-text-information" />;
        }
    };
                            ...
                            <div>
                                ...
                                <dd className="mt-1">
                                    <button
                                        ...
                                        className="text-text-information hover:text-text-information hover:underline"
                                    >
                                ...
                                <dd className="mt-1">
                                    {campaign.source_type === 'csv' ? (
                                        <button
                                            ...
                                            className="text-text-information hover:text-text-information hover:underline text-sm break-all"
                                        >
