...
import { type TooltipKey, useOnboarding } from '@/agentstudio/context/OnboardingContext';
...
export const OnboardingTooltip = ({
    ...
    const tooltipContent = (
        ...
        >
            ...
            <div
                ref={arrowRef}
                className="absolute h-4 w-4 rotate-45 bg-background-information-bold"
                style={{
            ...
            {/* Tooltip content */}
            <div className="relative bg-background-information-bold text-white rounded-lg shadow-2xl p-6 max-w-sm">
                {/* Close button */}
                <button
                    onClick={dismiss}
                    className="absolute top-2 right-2 p-1 hover:bg-background-information-bold rounded-full transition-colors"
                ...
                <div className="flex items-center justify-end gap-3">
                    <button
                        onClick={dismiss}
                        className="bg-white text-text-information px-4 py-1.5 rounded font-medium text-sm hover:bg-background-information transition-colors cursor-pointer"
                    >
                        Close
                    </button>
                    ...
                    {showNext && (
                        <button
                            ...
                            className="bg-white text-text-information px-4 py-1.5 rounded font-medium text-sm hover:bg-background-information transition-colors"
                        >
                            Next
                        </button>
                    )}
