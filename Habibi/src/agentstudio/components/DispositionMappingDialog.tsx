...
type Row = {
  /** The PayInt Voice Studio disposition being translated. Fixed for a built-in row. */
  source: string;
...
type Props = {
  ...
  /** Overrides currently stored, keyed by PayInt Voice Studio disposition. */
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Each PayInt Voice Studio disposition is sent as your own code wherever a call
        ...
        {isLoading ? (
          ...
          <>
            <div className="grid grid-cols-[1fr_1fr_auto] items-center gap-x-3 gap-y-1 px-1 text-xs font-medium text-muted-foreground">
              <span>PayInt Voice Studio disposition</span>
              <span>Your code</span>
              <span className="w-8" />
            </div>
                ...
                return (
                  ...
                  >
                    {row.builtIn ? (
                      ...
                      <Input
                        aria-label="PayInt Voice Studio disposition"
                        value={row.source}
                        disabled={isSaving}
                        onChange={(event) =>
                    ...
                    {row.builtIn ? (
                      <Button
                        ...
                        title="Reset to the PayInt Voice Studio disposition"
                      >
