...
import { createCredentialApiV1CredentialsPost } from "@/agentstudio/client";
import { CredentialResponse, WebhookCredentialType } from "@/agentstudio/client/types.gen";
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            <DialogContent className="sm:max-w-md">
                ...
                {error && (
                    <div className="flex items-start gap-2 p-3 text-sm text-text-danger bg-background-danger border border-border-danger rounded-md">
