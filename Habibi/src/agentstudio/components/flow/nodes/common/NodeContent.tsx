...
import { BaseHandle } from "@/agentstudio/components/flow/nodes/BaseHandle";
import { BaseNode } from "@/agentstudio/components/flow/nodes/BaseNode";
...
const DEFAULT_BADGE = { label: 'Node', className: 'bg-background-neutral-bold text-white' };
