...
import { useWorkflowOptional } from "@/agentstudio/app/workflow/[workflowId]/contexts/WorkflowContext";
    ...
    return (
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            >
                ...
                {error && (
                    <div className="flex items-center gap-2 rounded-md bg-background-danger p-3 text-sm text-text-danger border border-border-danger">
