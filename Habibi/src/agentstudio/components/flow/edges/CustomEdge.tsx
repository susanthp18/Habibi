...
import { useWorkflow, useWorkflowOptional } from "@/agentstudio/app/workflow/[workflowId]/contexts/WorkflowContext";
import { useWorkflowStore } from "@/agentstudio/app/workflow/[workflowId]/stores/workflowStore";
...
import { Dialog, DialogContent, DialogFooter, DialogHeader, DialogTitle } from "@/agentstudio/components/ui/dialog";
            ...
            <DialogContent className="max-h-[85vh] flex flex-col">
                <DialogHeader>
                    ...
                    {data?.invalid && data.validationMessage && (
                        <div className="mt-2 flex items-center gap-2 rounded-md bg-background-danger p-2 text-sm text-text-danger border border-border-danger">
