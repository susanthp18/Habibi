...
import type { DocumentResponseSchema } from "@/agentstudio/client/types.gen";
...
import { KNOWLEDGE_BASE_DOC_URL } from "@/agentstudio/constants/documentation";
                    ...
                    {completedDocuments.map((doc) => (
                        ...
                        >
                            ...
                            <div className="flex-1 space-y-1">
                                ...
                                >
                                    <div className="w-8 h-8 rounded-md bg-background-information-bold/10 flex items-center justify-center flex-shrink-0">
                                        <FileText className="w-4 h-4 text-text-information" />
                                    </div>
