...
import { Popover, PopoverContentInline, PopoverTrigger } from "@/agentstudio/components/ui/popover";
...
export function StaticTextWarning() {
    return (
        <div className="flex items-start gap-2 rounded-md bg-background-warning p-2 text-xs text-text-warning border border-border-warning">
