...
import { DateRangeFilter } from "@/agentstudio/components/filters/DateRangeFilter";
import { MultiSelectFilter } from "@/agentstudio/components/filters/MultiSelectFilter";
import { NumberFilter } from "@/agentstudio/components/filters/NumberFilter";
import { NumberRangeFilter } from "@/agentstudio/components/filters/NumberRangeFilter";
import { NumberSelectFilter } from "@/agentstudio/components/filters/NumberSelectFilter";
import { RadioFilter } from "@/agentstudio/components/filters/RadioFilter";
import { TagInputFilter } from "@/agentstudio/components/filters/TagInputFilter";
import { TextFilter } from "@/agentstudio/components/filters/TextFilter";
...
import { formatDateRange, formatNumberRange, getDefaultValue, resolveFilterAttributes, validateFilter } from "@/agentstudio/lib/filters";
import { ActiveFilter, DateRangeValue, FilterAttribute, FilterTemplate, filterTemplates, FilterValue, MultiSelectValue, NumberRangeValue, NumberValue, RadioValue, TextValue } from "@/agentstudio/types/filters";
          ...
          {resolvedActiveFilters.length > 0 && (
            <div className="space-y-3">
              ...
              {resolvedActiveFilters.map((filter, index) => (
                <Card key={index} className={filter.isValid ? "" : "border-border-danger"}>
            ...
            <div className="flex justify-between items-center gap-2 pt-2">
              ...
              {onAutoRefreshChange && (
                <div className="flex items-center space-x-2">
                  ...
                  {autoRefresh && (
                    <RefreshCw className="h-4 w-4 text-text-subtle animate-spin" />
                  )}
                </div>
              )}
