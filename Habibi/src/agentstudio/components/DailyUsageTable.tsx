import type { DailyUsageBreakdownResponse } from '@/agentstudio/client/types.gen';
...
import { formatCalendarDate } from '@/agentstudio/lib/dateTime';
            ...
            <Card>
                ...
                <CardContent>
                    <div className="animate-pulse space-y-3">
                        {[...Array(7)].map((_, i) => (
                            <div key={i} className="h-12 bg-background-neutral rounded"></div>
                        ))}
                    </div>
                </CardContent>
            </Card>
    ...
    if (!data || !data.breakdown || data.breakdown.length === 0) {
        return (
            <Card>
                ...
                <CardContent>
                    <p className="text-center py-8 text-text-subtle">No usage data available</p>
                </CardContent>
            </Card>
        );
    }
