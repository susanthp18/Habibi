...
import { MAX_TOPUP_USD, MIN_TOPUP_USD, startTopUp, TOPUP_PRESETS } from "@/agentstudio/lib/billing/topup";
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent align="end" className="w-72 space-y-3">
          ...
          {TOPUP_PRESETS.map((value) => (
            <button
              ...
              className={cn(
                ...
                selected === value && "border-primary bg-primary/10 text-foreground ring-1 ring-primary/40",
              )}
            >
              ${value}
            </button>
        ...
        <Button
          ...
          onClick={onBuy}
          disabled={!valid || busy}
          className="w-full bg-primary text-primary-foreground shadow-xs hover:bg-primary/90 focus-visible:ring-primary/50"
        >
