...
import { getDefaultConfigurationsApiV1UserConfigurationsDefaultsGet } from '@/agentstudio/client/sdk.gen';
...
import type { ModelOverrides } from "@/agentstudio/types/workflow-configurations";
...
export function ServiceConfigurationForm({
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            {apiError && <p className="text-text-danger mt-4">{apiError}</p>}
