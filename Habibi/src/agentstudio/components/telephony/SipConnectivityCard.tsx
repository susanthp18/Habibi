...
import type { SipConnectivityDetails } from "@/agentstudio/client/types.gen";
            ...
            <div className="max-w-xs space-y-2">
              <p className="flex items-center gap-2 text-sm font-medium">
                ...
                <span aria-hidden className="relative flex h-3 w-3 shrink-0">
                  <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-background-information-bold opacity-75" />
                  <span className="relative inline-flex rounded-full h-3 w-3 bg-background-information-bold" />
                </span>
              </p>
