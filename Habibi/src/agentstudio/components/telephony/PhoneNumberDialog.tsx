...
import type { PhoneNumberResponse, TrunkResponse } from "@/agentstudio/client/types.gen";
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-muted-foreground">
                {trunks.length > 1
                  ...
                  : "Calls from this number leave on this trunk. With a single trunk PayInt Voice Studio falls back to it anyway."}
              </p>
            </div>
          )}
