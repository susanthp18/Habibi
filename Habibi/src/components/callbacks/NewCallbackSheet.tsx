        ...
        <div className="flex shrink-0 items-center justify-between border-b border-border px-200 py-150">
          <div>
            ...
            <div className="text-body-small text-text-subtlest">
              Schedule a call, assign an owner, and queue reminders.
            </div>
          </div>
          <Button variant="ghost" size="sm" className="h-400 w-400 p-0" onClick={onClose}>
            <X className="h-4 w-4" />
          </Button>
        </div>
        ...
        <div className="min-h-0 flex-1 space-y-150 overflow-y-auto p-200 text-body-small">
          <div className="grid grid-cols-2 gap-150">
            ...
            <div className="col-span-2">
              ...
              <textarea
                ...
                disabled={busy}
                placeholder="What the customer said, agreed context, etc."
                className="min-h-[4.5rem] w-full rounded-medium border border-border bg-surface p-100 text-body-small"
              />
            </div>
          </div>
          ...
          {isDnd && (
            <div className="flex items-start gap-100 rounded-medium border border-border-warning bg-background-warning-subtler px-150 py-100 text-body-small text-text-warning-bolder">
              ...
              <div>
                This slot falls inside the customer's DND / outside their preferred window. Consider
                a safer time.
              </div>
            </div>
          )}
