...
export function RedactionStatsStrip({
  ...
  const tiles = [
    ...
    },
    {
      ...
      value: pendingReview,
      icon: FileLock2,
      hint: "Records with unreviewed PII",
      seed: false,
    },
    {
    ...
    <div className="grid shrink-0 grid-cols-2 gap-100 border-b border-border bg-surface px-250 py-150 md:grid-cols-5">
      {tiles.map((t) => {
        ...
        return (
          <div
            key={t.label}
            className="flex items-center gap-150 rounded-medium border border-border bg-surface-sunken px-150 py-100"
          >
            ...
            <div className="min-w-0">
              ...
              <div className="heading-small font-semibold text-text leading-tight">{t.value}</div>
