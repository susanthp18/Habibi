...
const BLUEPRINTS: Blueprint[] = [
  // NEW (fresh, some breaching)
  {
    ...
    amount: 12400,
    source: "bot_voice",
    snippet: "I paid this on the 12th via UPI, reference 8827194. Why is it still showing due?",
    capturedHoursAgo: 2,
    slaHoursFromCapture: 24,
    status: "new",
    priority: "high",
  },
  {
    ...
    amount: 3200,
    source: "bot_chat",
    snippet: "The amount you're asking for is wrong — my EMI is 4,850, not 8,050.",
    capturedHoursAgo: 6,
    slaHoursFromCapture: 24,
    status: "new",
    priority: "normal",
  },
  {
    ...
    amount: 18500,
    source: "bot_voice",
    snippet: "I never authorised this transaction. Please block the account immediately.",
    capturedHoursAgo: 1,
    slaHoursFromCapture: 4,
    status: "new",
    priority: "urgent",
  },
  {
    ...
    amount: 5400,
    source: "bot_chat",
    snippet: "You keep calling me about an account I don't own. Please stop.",
    capturedHoursAgo: 22,
    slaHoursFromCapture: 24,
    status: "new",
    priority: "high",
  },
  {
    ...
    amount: 2100,
    source: "agent",
    snippet: "You've charged me twice for the same month. Please refund one.",
    capturedHoursAgo: 30,
    slaHoursFromCapture: 24,
    status: "new",
    priority: "high",
  ...
  // UNDER REVIEW
  {
    ...
    amount: 9800,
    source: "bot_voice",
    snippet: "Payment cleared from my bank on the 3rd, please check with your ops team.",
    capturedHoursAgo: 26,
    slaHoursFromCapture: 48,
    status: "under_review",
    priority: "normal",
    assignee: "Priya Nair",
  },
  {
    ...
    amount: 750,
    source: "bot_chat",
    snippet: "I've been a customer for 8 years, please waive the late fee this once.",
    capturedHoursAgo: 40,
    slaHoursFromCapture: 72,
    status: "under_review",
    priority: "low",
  ...
  },
  {
    ...
    amount: 4600,
    source: "bot_voice",
    snippet: "The interest calculation looks wrong — I need a breakdown.",
    capturedHoursAgo: 18,
    slaHoursFromCapture: 48,
    status: "under_review",
    priority: "normal",
  ...
  },
  {
    ...
    amount: 22300,
    source: "agent",
    snippet: "Card was cloned in Dubai — I've filed a police complaint.",
    capturedHoursAgo: 12,
    slaHoursFromCapture: 24,
    status: "under_review",
    priority: "urgent",
  ...
  // AWAITING CUSTOMER
  {
    ...
    amount: 6700,
    source: "bot_chat",
    snippet: "Sent you the payment screenshot on WhatsApp yesterday.",
    capturedHoursAgo: 60,
    slaHoursFromCapture: 120,
  ...
  },
  {
    ...
    amount: 11200,
    source: "bot_voice",
    snippet: "That number doesn't belong to me anymore — must be the previous owner.",
    capturedHoursAgo: 96,
    slaHoursFromCapture: 168,
    status: "awaiting_customer",
    priority: "normal",
    assignee: "Priya Nair",
  },
  {
    ...
    amount: 500,
    source: "bot_chat",
    snippet: "First-time offender, please consider waiving.",
    capturedHoursAgo: 72,
    slaHoursFromCapture: 120,
    status: "awaiting_customer",
    priority: "low",
  ...
  // RESOLVED
  {
    ...
    amount: 8300,
    source: "bot_voice",
    snippet: "Payment was via NEFT on the 1st, reference NEFT-77281.",
    capturedHoursAgo: 120,
    slaHoursFromCapture: 48,
    status: "resolved",
    priority: "normal",
    assignee: "Ananya Iyer",
  },
  {
    ...
    amount: 1500,
    source: "bot_chat",
    snippet: "Charged twice on the 20th, please refund.",
    capturedHoursAgo: 96,
    slaHoursFromCapture: 48,
    status: "resolved",
    priority: "normal",
  ...
  },
  {
    ...
    amount: 350,
    source: "agent",
    snippet: "Long-tenure customer requested one-time goodwill waiver.",
    capturedHoursAgo: 140,
    slaHoursFromCapture: 72,
    status: "resolved",
    priority: "low",
    assignee: "Sana Kapoor",
  ...
  // REJECTED
  {
    ...
    amount: 4200,
    source: "bot_voice",
    snippet: "This isn't my account.",
    capturedHoursAgo: 200,
    slaHoursFromCapture: 72,
    status: "rejected",
    priority: "normal",
    assignee: "Kabir Rao",
  },
  {
    ...
    amount: 1100,
    source: "bot_chat",
    snippet: "Please waive — I forgot to pay.",
    capturedHoursAgo: 240,
    slaHoursFromCapture: 72,
    status: "rejected",
    priority: "low",
    assignee: "Rohan Sethi",
  },
  {
    ...
    amount: 900,
    source: "agent",
    snippet: "You've over-charged me.",
    capturedHoursAgo: 180,
    slaHoursFromCapture: 48,
    status: "rejected",
    priority: "normal",
    assignee: "Ananya Iyer",
...
function eventsForStatus(bp: Blueprint, capturedAt: string): DisputeEvent[] {
  ...
  if (bp.status === "awaiting_customer") {
    evts.push({
      at: capturedAt,
      label: "Requested evidence from customer via WhatsApp",
      actor: bp.assignee,
      tone: "info",
    });
  }
  if (bp.status === "resolved") {
    evts.push({
      at: capturedAt,
      label: "Evidence reviewed — dispute upheld",
      actor: bp.assignee,
      tone: "success",
    });
    evts.push({
      at: capturedAt,
      label: "Resolution written back to CRM",
      actor: "System",
      tone: "success",
    });
  }
  if (bp.status === "rejected") {
    evts.push({
      at: capturedAt,
      label: "Insufficient evidence — dispute rejected",
      actor: bp.assignee,
      tone: "danger",
    });
  }
...
export const disputes: DisputeRecord[] = _disputes;

/**
 * Mock-only: dress a stored record in the SLA fields the live API sends, so
 * both branches of api/disputes.ts hand the screens the identical shape.
 */
...
export function resolveDispute(id: string, code: ResolutionCode, notes: string) {
  ...
  d.events.push({
    at,
    label: `Resolved · ${RESOLUTION_LABELS[code]}`,
    actor: CURRENT_AGENT,
    tone: "success",
  });
  d.events.push({
    at,
    label: "Written back to CRM (Customer 360 · Disputes)",
    actor: "System",
    tone: "success",
  });
}
