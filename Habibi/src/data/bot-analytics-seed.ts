...
export const unansweredQuestions: UnansweredQuestion[] = [
  { id: "u1", text: "Can I pay in three instalments after due date without CIBIL hit?", hits: 84, lastSeen: todayIso(0), topIntent: "late-fee", hasKbDoc: false, suggestedFix: "kb" },
  { id: "u2", text: "What's the interest rate if I only pay minimum?", hits: 71, lastSeen: todayIso(0), topIntent: "emi", hasKbDoc: true, suggestedFix: "prompt" },
  { id: "u3", text: "How do I get a NOC after full closure?", hits: 63, lastSeen: todayIso(1), topIntent: "statement", hasKbDoc: false, suggestedFix: "kb" },
  { id: "u4", text: "Can waiver be given if job loss proof provided?", hits: 58, lastSeen: todayIso(0), topIntent: "late-fee", hasKbDoc: false, suggestedFix: "both" },
  { id: "u5", text: "Explain foreclosure charges for personal loan", hits: 52, lastSeen: todayIso(2), topIntent: "emi", hasKbDoc: true, suggestedFix: "prompt" },
  { id: "u6", text: "How to change EMI debit date?", hits: 47, lastSeen: todayIso(1), topIntent: "emi", hasKbDoc: false, suggestedFix: "kb" },
  { id: "u7", text: "Is there a moratorium option for medical emergency?", hits: 41, lastSeen: todayIso(3), topIntent: "late-fee", hasKbDoc: false, suggestedFix: "kb" },
  { id: "u8", text: "Why was late fee ₹599 vs standard ₹450?", hits: 39, lastSeen: todayIso(0), topIntent: "dispute", hasKbDoc: true, suggestedFix: "prompt" },
  { id: "u9", text: "Can I convert overdue balance to EMI?", hits: 34, lastSeen: todayIso(2), topIntent: "topup", hasKbDoc: false, suggestedFix: "both" },
  { id: "u10", text: "What documents needed for top-up on existing loan?", hits: 31, lastSeen: todayIso(1), topIntent: "topup", hasKbDoc: false, suggestedFix: "kb" },
  { id: "u11", text: "Language switch to Tamil not working mid-call", hits: 27, lastSeen: todayIso(0), topIntent: "language", hasKbDoc: false, suggestedFix: "prompt" },
  { id: "u12", text: "Bot repeats verification after I already verified", hits: 24, lastSeen: todayIso(1), topIntent: "other", hasKbDoc: false, suggestedFix: "prompt" },
];
