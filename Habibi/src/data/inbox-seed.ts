...
export const threads: Thread[] = [
    ...
    messages: [
      {
        id: "m1",
        sender: "bot",
        text: "Hi Rahul, this is HDFC Collections Assistant. I see an outstanding of ₹18,400 on account ending 9123. How can I help?",
        time: "3:32 PM",
        delivery: "read",
      },
      {
        id: "m2",
        sender: "customer",
        text: "I already paid this on 12 Nov via UPI.",
        time: "3:34 PM",
      },
      {
        id: "m3",
        sender: "bot",
        text: "Thanks for letting me know. Could you share the UPI reference number so I can check?",
        time: "3:34 PM",
        delivery: "read",
      },
      { id: "m4", sender: "customer", text: "It was 4429871122. Please check.", time: "3:36 PM" },
      {
        id: "m5",
        sender: "bot",
        text: "I can see a pending reconciliation for that reference. I'm capturing this as a dispute so a specialist can review.",
        time: "3:37 PM",
        delivery: "read",
      },
      {
        id: "s1",
        kind: "system",
        text: "Bot captured dispute D-4821 · flagged for human review",
        time: "3:38 PM",
      },
      {
        id: "m6",
        sender: "customer",
        text: "Why is it showing due? This is frustrating.",
        time: "3:41 PM",
      },
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "call",
          summary: "Inbound · dues query resolved by bot",
          when: "2d ago",
          sentiment: "neutral",
        },
        {
  ...
  },
  {
    ...
    lastFrom: "customer",
    sentiment: "positive",
    ragSuggestions: ["Late-fee waiver eligibility", "How to enable auto-debit"],
    messages: [
      {
        id: "m1",
        sender: "customer",
        text: "Hi, I want to know if my late fee can be waived this month.",
        time: "3:20 PM",
      },
      {
        id: "m2",
        sender: "bot",
        text: "I can't approve a fee reversal on this chat. I'll log a specialist review against the live authority ceiling — they'll confirm what, if anything, can be reversed.",
        time: "3:21 PM",
        delivery: "read",
      },
      { id: "m3", sender: "customer", text: "Yes please.", time: "3:22 PM" },
      {
        id: "m4",
        sender: "bot",
        text: "I've logged a fee-waiver review. A specialist will confirm the outcome. Anything else?",
        time: "3:22 PM",
        delivery: "read",
      },
      {
        id: "m5",
        sender: "customer",
        text: "Thanks, that's all I needed for now.",
        time: "3:29 PM",
      },
    ],
    context: {
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "chat",
          summary: "Late-fee waiver logged for review",
          when: "just now",
          sentiment: "positive",
        },
      ],
    ...
    messages: [
      {
        id: "m1",
        sender: "customer",
        text: "You have charged my EMI twice in October. Fix it.",
        time: "2:41 PM",
      },
      {
        id: "m2",
        sender: "bot",
        text: "I'm sorry to hear that. I can see two debits of ₹7,200 on 05 Oct and 07 Oct. I'm capturing this as a billing dispute now.",
        time: "2:42 PM",
        delivery: "read",
      },
      {
        id: "s1",
        kind: "system",
        text: "Bot escalated to human · reason: repeat charge",
        time: "2:44 PM",
      },
      {
        id: "m3",
        sender: "customer",
        text: "I've been a customer for 8 years. This is unacceptable.",
        time: "2:50 PM",
      },
      {
        id: "m4",
        sender: "customer",
        text: "I want to speak with a manager immediately.",
        time: "2:58 PM",
      },
    ],
    context: {
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "call",
          summary: "Inbound · escalated, sentiment declining",
          when: "20m ago",
          sentiment: "negative",
        },
        {
          id: "i2",
          kind: "chat",
          summary: "Statement request fulfilled",
          when: "6d ago",
          sentiment: "neutral",
        },
      ],
  ...
  },
  {
    ...
    lastFrom: "agent",
    sentiment: "positive",
    ragSuggestions: ["Restructuring options — retail loan", "Callback scheduling policy"],
    messages: [
      {
        id: "m1",
        sender: "customer",
        text: "Can someone call me later today to discuss restructuring?",
        time: "1:02 PM",
      },
      {
        id: "m2",
        sender: "bot",
        text: "Absolutely. When works best for you?",
        time: "1:02 PM",
        delivery: "read",
      },
      ...
      { id: "s1", kind: "system", text: "You took over from bot · 1:10 PM", time: "1:10 PM" },
      {
        id: "m4",
        sender: "agent",
        text: "Hi Meera, Priya here from HDFC. I've scheduled your callback for today 5:30 PM IST.",
        time: "1:12 PM",
        delivery: "read",
      },
      { id: "m5", sender: "customer", text: "Perfect, thank you.", time: "1:13 PM" },
      {
        id: "m6",
        sender: "agent",
        text: "Great, I'll call you at 5:30 PM sharp.",
        time: "1:14 PM",
        delivery: "delivered",
      },
    ],
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "chat",
          summary: "Callback scheduled 5:30 PM",
          when: "just now",
          sentiment: "positive",
        },
        {
          id: "i2",
          kind: "call",
          summary: "Inbound · discussed restructuring",
          when: "1w ago",
          sentiment: "neutral",
        },
      ],
    ...
    messages: [
      {
        id: "m1",
        sender: "customer",
        text: "Please send my loan statement for last financial year.",
        time: "12:45 PM",
      },
      {
        id: "m2",
        sender: "bot",
        text: "Sure — sharing the FY 2024-25 statement now.",
        time: "12:46 PM",
        delivery: "read",
      },
      {
        id: "s1",
        kind: "system",
        text: "Document sent · loan-statement-FY24-25.pdf",
        time: "12:47 PM",
      },
      {
        id: "m3",
        sender: "bot",
        text: "I've sent the FY 2024-25 statement to your WhatsApp.",
        time: "12:48 PM",
        delivery: "delivered",
      },
    ],
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "chat",
          summary: "Statement delivered on WhatsApp",
          when: "just now",
          sentiment: "neutral",
        },
      ],
    ...
    messages: [
      {
        id: "m1",
        sender: "customer",
        text: "I closed my personal loan last month. Need the NOC letter.",
        time: "11:20 AM",
      },
      {
        id: "m2",
        sender: "bot",
        text: "Your loan closure is confirmed on 22 Oct. NOC generation takes up to 3 business days.",
        time: "11:22 AM",
        delivery: "read",
      },
      {
        id: "m3",
        sender: "customer",
        text: "I need the NOC urgently for a home loan application.",
        time: "11:32 AM",
      },
    ],
    context: {
    ...
    messages: [
      {
        id: "m1",
        sender: "bot",
        text: "Hi Ravi, this is a reminder that your promise of ₹22,000 was due yesterday. Have you made the payment?",
        time: "10:02 AM",
        delivery: "delivered",
      },
      {
        id: "m2",
        sender: "customer",
        text: "Sorry, I couldn't pay yesterday. Can we do next week?",
        time: "10:04 AM",
      },
    ],
    context: {
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "call",
          summary: "Inbound · promised ₹22,000 by 18 Nov",
          when: "3d ago",
          sentiment: "neutral",
        },
      ],
  ...
  },
  {
    ...
    messages: [
      { id: "m1", sender: "customer", text: "I paid ₹5,000 today.", time: "9:40 AM" },
      {
        id: "m2",
        sender: "bot",
        text: "Thanks Sneha — I can see the ₹5,000 partial payment. That leaves ₹10,000 remaining from your promise.",
        time: "9:41 AM",
        delivery: "read",
      },
      { id: "m3", sender: "customer", text: "Yes, I'll pay the rest next week.", time: "9:43 AM" },
      {
        id: "m4",
        sender: "bot",
        text: "Noted — I've updated your promise. Since you're paying regularly, would you like to hear about our debt-consolidation offer?",
        time: "9:47 AM",
        delivery: "delivered",
      },
    ],
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "chat",
          summary: "Upsell offer presented",
          when: "just now",
          sentiment: "positive",
        },
      ],
  ...
  },
  {
    ...
    messages: [
      { id: "m1", sender: "customer", text: "When is my next EMI due?", time: "6:12 PM" },
      {
        id: "m2",
        sender: "bot",
        text: "Your next EMI of ₹9,200 is due on 28 Nov.",
        time: "6:12 PM",
        delivery: "read",
      },
    ],
    ...
    messages: [
      {
        id: "m1",
        sender: "bot",
        text: "Hi Aarav, this is a reminder about your overdue amount of ₹34,500.",
        time: "5:00 PM",
        delivery: "delivered",
      },
      { id: "m2", sender: "customer", text: "Stop contacting me on SMS.", time: "5:02 PM" },
      {
        id: "s1",
        kind: "system",
        text: "Bot detected DND request · escalated to human",
        time: "5:03 PM",
      },
      {
        id: "m3",
        sender: "customer",
        text: "Stop calling me. I've asked twice already.",
        time: "5:14 PM",
      },
    ],
    context: {
      ...
      recentInteractions: [
        {
          id: "i1",
          kind: "call",
          summary: "Inbound · customer angry",
          when: "3d ago",
          sentiment: "negative",
        },
      ],
