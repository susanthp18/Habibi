...
export const PromiseRevisionResponse = z.object({
  "seq": z.number(),
  "priorAmount": z.number(),
  "priorPromisedDate": z.string(),
  "amount": z.number(),
  "promisedDate": z.string(),
  "reason": z.enum(["customer_requested_delay", "salary_delayed", "medical", "dispute_raised", "partial_payment_agreed", "agent_correction", "other"]),
...
export const PromiseResponse = z.object({
  ...
  "channel": z.enum(["voice", "whatsapp", "chat", "email", "sms"]),
  "handler": z.string(),
  "status": z.enum(["upcoming", "due_today", "kept", "broken", "partial", "cancelled"]),
  "reminderStatus": z.enum(["off", "queued", "scheduled", "sent", "acknowledged", "failed"]),
  "revisionCount": z.number().optional(),
  "cancelReason": z.string().nullable().optional(),
  "revisions": z.array(PromiseRevisionResponse).optional(),
}).passthrough();
...
export const ConversationListResponse = z.object({
  ...
  "lastFrom": z.enum(["customer", "bot", "agent", "system"]),
  "sentiment": z.enum(["positive", "neutral", "negative"]),
...
export const ROUTES: ReadonlyArray<readonly [string, z.ZodTypeAny]> = [
  ...
  ["POST /promises/{promise_id}/revise", PromiseResponse],
  ["POST /promises/{promise_id}/cancel", PromiseResponse],
