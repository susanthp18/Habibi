...
from agent_core.cards import gates_outbound
from agent_core.cards.gates_outbound import (  # noqa: F401  (re-exported)
    OUTCOME_CODES,
    POST_CALL_ACTIONS,
...
def compile_card(
    *,
    ...
    return CompileReport(
        ...
        mission_entries=gates_outbound.mission_entries(flow),
        card=st.dump,
    )
