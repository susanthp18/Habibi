"""Grant connector.attach and policy.export to stock roles.

Revision ID: 20260815_0079
Revises: 20260815_0078
Create Date: 2026-08-15

Phase 5 added perm-connector-attach and perm-policy-export to
PERMISSION_CATALOG. Admin's ROLE_DEFAULTS is ALL_PERMISSIONS, so the stock
admin role must receive the new rows or the grants table silently lags.
"""
...
down_revision: Union[str, Sequence[str], None] = "20260815_0078"
