...
- **URL:** `http://localhost:8080/integrations`
...
- **Stack notes:** Providers/connectors/MCP/A2A/vault.

## 1. UI/UX issues, bugs, inconsistencies, staleness
- **Medium:** **Loading integrations**; taxonomy Providers / Connectors / Our MCP / A2A / Vault / Gateway is six products.
- **Medium:** sandbox|production toggle without visible connection health.


## 2. High-value gaps for a next-gen AI collections platform
- Business catalog: Core banking, LMS, Dialer, WhatsApp, Payments — Advanced for MCP/A2A.
- Contract tests per connector; last successful sync.


## 3. Other bugs / issues
- Map each connector to permissions in Roles.
...
- Extract: Loading integrations; LOADING_00=1.
