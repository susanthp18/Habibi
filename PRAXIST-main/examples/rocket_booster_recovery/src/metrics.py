...
rate is a view of the same ``landing_success_pass`` array.
"""
...
def first_contact_arrays(
    ...
    """Return diagnostics and the repository's only success predicate.
    ...
    for diagnostics but can never pass because contact detection is required.
    """
