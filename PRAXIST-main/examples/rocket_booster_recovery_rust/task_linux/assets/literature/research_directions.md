...
- Candidate implementation uses Rust and CPU execution. Candidate-local Rust
  modules and finite `variant_params` are allowed; no Python/JAX helper, GPU
  backend, new Cargo dependency, filesystem/network access, or subprocess may
