...
* (h) any Child(ren) must be accompanied by a parent, who is an Insured Person during the Trip; and
...
10. Any Pre-Existing Medical Condition that has worsened within thirty (30) days prior to the Trip, for which a Registered Medical Practitioner has recommended consulting a Specialist, undergoing diagnostic tests, having surgery, altering prescribed medication or dosage, or changing treatment.
...
## Discounts offered
Single Trip/Travel policy 60% discount
Annual Travel/Multi trip policy 50% discount


## Promotion Terms and Conditions
The promotion runs from now until 31 March 2026. All customers who purchase any Travel Insurance policy (Travel Protect360 Single Trip Plan or Travel Protect360 Annual Plan) will automatically be enrolled into the Travel Protect360 Insurance No Claim Discount (NCD) programme.
Travel Protect360 Single Trip Plan Policyholder(s) who return from trip and does not make any claim against the policy will be eligible for an additional 5% NCD promotion code.
The NCD promotion code, if eligible, will be automatically sent to you on the 35th day from the end date of your Travel Insurance Policy.
For subsequent Single Trip Plan purchases, policyholder(s) who previously received the additional 5% discount promotion code and continue to have no claim(s) against the policy will be eligible for an additional 10% NCD promotion code, with the discount capped at a maximum of additional 10% for all subsequent eligible trips.
Travel Protect360 Single Trip NCD promotion codes have a validity of 90 days from the date of issuance.
Promotion codes provided for eligible Single Trip Plan purchases can only be utilised for the next Single Trip Plan purchase and can be used only once.
Newly issued NCD promotion code will replace any previously issued and unused NCD promotion code. For avoidance of doubt, if a newly issued NCD promotion code is replacing an existing code, the new NCD code will be either of the same value or higher.
For Travel Protect360 Annual Plan Policyholder(s) who has completed the policy period of one (1) year and has no claim(s) during the policy period and within the stipulated timeframe of 30 days from the policy end date, will be eligible for an additional 10% NCD on their Travel Protect360 Annual Plan’s auto renewal.
The NCD promotion code is tagged to the owner of the policy; they are not transferable.
Should a travel policy purchased with a NCD promotion code be cancelled, no refund will be given for the discounted premium.
